...
module.exports = async (req, res) => {
    ...
    return res.status(403).send(`
      ...
      <body style="font-family:sans-serif;text-align:center;padding:60px;
        ...
        <p>Escríbenos a <a href="mailto:contacto@vciso.cl"
           style="color:#f47c47">contacto@vciso.cl</a> y te enviamos uno nuevo.</p>
        <a href="/vciso_ebook.html"
  ...
  // Mostrar página de descarga y redirigir a serve-pdf
  return res.send(`
    ...
    <head>
      ...
      <style>
        ...
        .email-tag { background: rgba(232,93,38,0.15); border: 1px solid rgba(232,93,38,0.3);
    ...
    <body>
      <div class="card">
        ...
        <div class="email-tag">🔒 Personalizado para ${info.email}</div>
        <p style="font-size:0.85rem">
          El PDF incluye tu email como marca de agua en cada página.
        </p>
